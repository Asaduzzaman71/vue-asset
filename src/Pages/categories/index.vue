...
<AdminLayout>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" data-kt-initialized="1">
                            <a @click="showModal = true" class="btn btn-sm btn-light btn-active-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
    ...
    <form-modal v-model="showModal" title="Add Category" @submit="onSubmit"
    @cancel="onCancel">
        <InputText
...
import InputText from '@/components/el/InputText.vue';
 defineOptions({
  name: 'CategoryList'
});
