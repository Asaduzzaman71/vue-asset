	...
	<!-- eslint-disable -->
    		<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							...
							<div id="kt_app_sidebar_toggle" @click="toggleSideBar()" class="app-sidebar-toggle btn btn-icon btn-shadow btn-sm btn-color-muted btn-active-color-primary body-bg h-30px w-30px position-absolute top-50 start-100 translate-middle rotate" :class="isSideBarToggle ? 'active' : '' " data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="app-sidebar-minimize">
						...
						<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<!--end:Menu item-->
									<!--begin:Menu item-->
									<div data-kt-menu-trigger="click" @click="menuStore.activeMenu('user')" class="menu-item menu-accordion" :class="menuStore.selectedMenu == 'user' && menuStore.isCollapseMenu ? 'hover show' : ''">
										<!--begin:Menu link-->
										<span class="menu-link">
											<span class="menu-icon">
										...
										<!--end:Menu link-->
										<!--begin:Menu sub-->
										<div class="menu-sub menu-sub-accordion" :class="menuStore.selectedMenu == 'category' && menuStore.isCollapseMenu ? 'show' : ''">
											<!--begin:Menu item-->
											<div class="menu-item">
												<!--begin:Menu link-->
												<router-link :to="{name: 'CategoryList'}" class="menu-link" @click.stop="menuStore.activeSubMenu('category','list')"   :class="menuStore.isCurrent('category','list') ? 'active' : ''">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
									...
									<!--end:Menu item-->
									<!--begin:Menu item-->
									<div data-kt-menu-trigger="click" @click="menuStore.activeMenu('pricing')"  class="menu-item menu-accordion" :class="menuStore.selectedMenu == 'pricing' && menuStore.isCollapseMenu ? 'hover show' : ''">
										<!--begin:Menu link-->
										<span class="menu-link">
											<span class="menu-icon">
										...
										<div class="menu-sub menu-sub-accordion menu-active-bg">
											...
											<div class="menu-item"  >
												<!--begin:Menu link-->
												<a class="menu-link" @click.stop="menuStore.activeSubMenu('pricing','column')"  :class="menuStore.isCurrent('pricing','column') ? 'active' : ''">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
											...
											<div class="menu-item" >
												<!--begin:Menu link-->
												<a class="menu-link" @click.stop="menuStore.activeSubMenu('pricing','table')"   :class="menuStore.isCurrent('pricing','table') ? 'active' : ''">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
...
let isSideBarToggle = ref(false)
function toggleSideBar(){
	document.body.dataset.ktAppSidebarMinimize == 'on' ? document.body.removeAttribute('data-kt-app-sidebar-minimize')  : document.body.setAttribute('data-kt-app-sidebar-minimize', 'on')
